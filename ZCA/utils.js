...
export const logger = {
    verbose: (...args) => {
        console.log("\x1b[90mVERBOSE\x1b[0m", ...args); // Xám
    },
    info: (...args) => {
        console.log("\x1b[32mINFO\x1b[0m", ...args); // Xanh lá
    },
    warn: (...args) => {
        console.log("\x1b[33mWARN\x1b[0m", ...args); // Vàng
    },
    error: (...args) => {
        console.log("\x1b[31mERROR\x1b[0m", ...args); // Đỏ
    },
};
